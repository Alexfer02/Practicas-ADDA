...
public class TestEjercicio2 {
	...
	private static List<Trio<BiConsumer<List<Integer>, Integer>, TipoAjuste, String>> metodosUmbral = List.of(
			Trio.of(Ejercicio2::sort, TipoAjuste.NLOGN_0, "Quicksort(analisisumbral)") // Análisis del tamaño umbral con una única lista de tamaño sizeMax
			); 
	...
	public static void muestraGraficas(List<Trio<BiConsumer<List<Integer>, Integer>, TipoAjuste, String>> metodos, String title) {
	...
	public static void muestraGraficasDistintosUmbralesQS() {
		...
		List<String> ficherosSalida = List.of("ficheros/TiemposQuicksort(analisisumbral).csv","ficheros/TiemposQuicksort(complejidad).csv");
		//Lista de las etiquetas dadas a cada experimento con diferente umbral
		List<String> labels = List.of("umbral 4","umbral 25","umbral 50" ,"umbral 75");
